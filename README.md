...
* When opening the Perception project in Linux Editor, a package dependency on Python will be added and will cause compile errors. This can be fixed by changing the package.json file manually.
